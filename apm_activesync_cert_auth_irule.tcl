...
# Modified by: Brett Smith (2019-02-05)
...
# SSL renegotiate HTTP_REQUEST must happen before the apm_activesync_cert_auth iRule
...
when HTTP_REQUEST priority 200 {
    ...
    # form the user key from a hash of the Username and DeviceID
...
when ACCESS_SESSION_STARTED priority 400 {
    ...
    if { [ info exists user_key ] } {
        # set their uuid to be their user key (user + deviceid)
